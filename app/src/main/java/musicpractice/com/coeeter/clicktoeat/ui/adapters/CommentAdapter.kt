...
//        val binding = UpdateCommentDialogBinding.inflate(LayoutInflater.from(context))
//
...
//                if (s.toString() == comment.review || s.toString().isEmpty()) {
//                    review = s.toString()
...
//
//                val rating = index + 1
//                if (rating == comment.rating || review.isEmpty()) {
//                    binding.submitBtn.isEnabled = false

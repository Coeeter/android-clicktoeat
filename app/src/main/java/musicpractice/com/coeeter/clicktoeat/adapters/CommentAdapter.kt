...
import musicpractice.com.coeeter.clicktoeat.repository.models.LikesAndDislikesModel
...
class CommentAdapter(private val context: Context, private val restaurant: RestaurantModel) :
    ...
    override fun onBindViewHolder(holder: CommentAdapter.ViewHolder, position: Int) {
        ...
        token =
            context.getSharedPreferences("memory", Context.MODE_PRIVATE)
                .getString("token", "")
                .toString()
        ...
        if (commentedUser.imagePath != null) {
            val imagePath =
                "${context.getString(R.string.base_url)}/upload/${commentedUser.imagePath}"
        ...
        val loggedInUserProfile =
            context.getSharedPreferences("memory", Context.MODE_PRIVATE).getString("profile", "")
            ...
            holder.binding.edit.setOnClickListener {
                ...
                popup.setOnMenuItemClickListener { menuItem: MenuItem ->
                    when (menuItem.itemId) {
                        ...
                        R.id.miDelete -> CommentViewModel.deleteComment(token, comment.id)
                    }
                    true
                }
    ...
    private fun editComment(comment: CommentModel) {
        ...
        val binding =
            UpdateCommentDialogBinding.inflate(LayoutInflater.from(context))
